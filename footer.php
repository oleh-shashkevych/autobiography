...
<div class="popup-wrapper" id="fluent-form-popup" role="dialog" aria-modal="true" aria-hidden="true">
    <div class="popup-overlay" tabindex="-1"></div>
    <div class="popup-content">
        <button class="popup-close-button" aria-label="<?php echo esc_attr(autobiography_translate_string('Закрити', 'Close')); ?>">
